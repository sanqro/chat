...
|    16.1    | 16      | Die API und die fertige Webseite wurden beide deployed. Es wurde schon eine Nachricht in den aktuellen Chatraum gesendet.                                                                                                                                                      | Jest         | Nachricht mit dem eigenen privaten Schlüssel entschlüsseln.                                                      | Die entschlüsselte Nachricht beinhaltet den gleichten Text wie vor dem Verschlüsseln.                                                                             |
